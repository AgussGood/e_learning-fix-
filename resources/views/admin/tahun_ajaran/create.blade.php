...
<div class="container mt-4">
    <div class="col-md-8 offset-md-2">
        <h3 class="mb-4">Tambah Tahun Ajaran</h3>
        ...
        <form action="{{ route('tahun_ajaran.store') }}" method="POST" class="card p-4 shadow-sm">
            @csrf

            <div class="mb-3">
                <label for="nama" class="form-label">Nama Tahun Ajaran</label>
                <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror"
                    value="{{ old('nama') }}" placeholder="Contoh: 2024/2025">
                @error('nama')
