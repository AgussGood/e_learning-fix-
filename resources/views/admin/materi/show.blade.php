                            ...
                            <div class="card-style mb-30">
                                ...
                                <div class="input-style-1">
                                    ...
                                    <input type="text" name="judul" required
                                        class="@error('judul') is-invalid @enderror" value="{{ $materi->judul }}"
                                        readonly />
                                </div>
                                <div class="mb-3">
                                    <label for="" class="form-label">Foto</label><br>
                                    <img src="{{ asset('storage/materi/' . $materi->foto) }}" alt=""
                                    ...
                                    <div class="select-style-1">
                                        ...
                                        <div class="select-position">
                                            <input type="text" name="isi_materi" required
                                                class="@error('isi_materi') is-invalid @enderror"
                                                value="{{ $materi->isi_materi }}" readonly />
                                        </div>
                                    </div>
                                </div>
                                <div class="input-style-2">
                                    <div class="select-style-1">
                                        ...
                                        <div class="select-position">
                                            <input type="text" name="mapel" required
                                                class="@error('mapel') is-invalid @enderror"
                                                value="{{ $materi->mapel->nama_mapel }}" readonly />
                                        </div>
                                    </div>
                                </div>
                                <!-- end input -->
                                    ...
                                    <div class="select-style-1">
                                        ...
                                        <div class="select-position">
                                            <input type="text" name="kelas" required
                                                ...
                                                value="{{ $materi->kelas->kelas }}" readonly />
                                        </div>
                                    </div>
                                </div>
